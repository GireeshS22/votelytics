/**
 * Bastion Seats Analysis page - Shows constituencies held by same party across three elections
 */
...
function BastionAnalysis() {
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <MetaTags
        title="Bastion Seats Analysis - Tamil Nadu Elections"
        description="Analysis of constituencies held by the same party across 2011, 2016, and 2021 elections in Tamil Nadu"
        keywords={PAGE_SEO.analysis.keywords}
        canonical={`${SEO_CONFIG.siteUrl}/analysis/bastion`}
...
export default BastionAnalysis;
