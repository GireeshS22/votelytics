  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 rounded-2xl shadow-2xl p-8 mb-8 text-white overflow-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <button
          onClick={() => navigate('/')}
          className="flex items-center gap-2 text-white hover:text-blue-100 transition-all mb-6 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg backdrop-blur-sm border border-white/20"
        >
          <svg
            className="w-5 h-5"
            fill="none"
